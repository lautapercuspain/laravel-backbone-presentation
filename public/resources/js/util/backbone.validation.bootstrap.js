_.extend(Backbone.Validation.callbacks, {
  valid: function(view, attr, selector){
    // console.log("This attrs are valid %s", attr);
//      console.log('pasa por aqui');
  ...
  invalid: function(view, attr, error, selector) {
        // console.log("This attrs are Invalid %s", attr);
//      console.log('el mensaje de error es %s, el selector es %s, y el atributo es %s', error, selector, attr);
